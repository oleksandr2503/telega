  ...
  <meta http-equiv="refresh" content="0.2; url='tg://join?invite=j4aBfVZBfK4zMmRi'" />
 <script>
  ...
  <div class="header">
    <img src="img/LogoBig_1x.png" alt="">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          <img class="avatar" src="img/logo_m.png">
          <!-- Заголовок канала -->
          <h1 class="jumbotron-heading">Fortunatos Agency</h1>
          <!-- Описание, укажите здесь то, что замотивирует человека подписаться -->
          <p style="display:block" class="lead text-muted">🚀 In-House Marketing Agency 🚀<br><br>💡 Хочеш завжди бути в темі? Наш Telegram-канал для маркетологів - це твоє джерело актуальних новин і тактик. Приєднуйся!</p>
          <p>
